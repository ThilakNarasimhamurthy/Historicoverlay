...
function SignInPage() {
    ...
    const [loginMutation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$apollo$2f$operations$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOGIN"], {
        onCompleted: {
            "SignInPage.useMutation": (data)=>{
                try {
                    const { token, user } = data.login;
                    // Use Apollo cache instead of localStorage
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$apollo$2f$operations$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(token, user);
                    ...
                    setTimeout({
                        "SignInPage.useMutation": ()=>{
                            router.replace(target);
                        }
                    }["SignInPage.useMutation"], 100);
                } catch (err) {
...
_s(SignInPage, "t07bopT2Xp91okpr1o+hfX32EWY=", false, function() {
    return [
...
//# sourceMappingURL=_68c656e8._.js.map