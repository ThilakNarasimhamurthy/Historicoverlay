...
function SignupRolePage() {
    ...
    const handleNext = ()=>{
        if (role === 'student') router.push('/auth/signup/details/student');
        else if (role === 'university') router.push('/auth/signup/details/university');
        router.push('/auth/signup/details/org?role=' + role);
    };
 ...
 */ 
_s(SignupRolePage, "C7PkQQvDWuAtf/ddjID6VqQZx3k=", false, function() {
    return [
...
_c = SignupRolePage;
var _c;
__turbopack_context__.k.register(_c, "SignupRolePage");
...
//# sourceMappingURL=_68bd7391._.js.map