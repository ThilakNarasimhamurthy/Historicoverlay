...
const GET_AUTH_STATUS = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$tag$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gql"]`
  query GetAuthStatus {
    isLoggedIn @client
    currentUser @client
  }
...
function AuthProvider({ children }) {
    ...
    const { data, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(GET_AUTH_STATUS);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            if (publicRoutes.some({
                "AuthProvider.useEffect": (route)=>pathname?.startsWith(route)
            }["AuthProvider.useEffect"])) {
                // If user is logged in and trying to access auth pages, redirect to dashboard
                if (isLoggedIn && (pathname?.includes('/auth/') || pathname === '/')) {
                    const homePage = currentUser?.role ? roleHomePages[currentUser.role.toLowerCase()] : '/dashboard';
...
_s(AuthProvider, "JVGE2NNg1FeTVtEtxIIICKcqaWM=", false, function() {
    return [
...
//# sourceMappingURL=app_apollo_provider_tsx_ad2f7bbe._.js.map